...
class MapViewBaseDemoViewController: UIViewController, BMKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        segment.addTarget(self, action: #selector(MapViewBaseDemoViewController.changeMapAction(_:)), forControlEvents: .ValueChanged)
    ...
    func changeMapAction(segment: UISegmentedControl) {
        /*
